...
import com.rh.financeiro.service.CertificacoesService;
...
public class CertificacoesController {
    ...
    public ResponseEntity findAll() {
        List<Certificacoes> certificados = service.buscaTodos();
        return ResponseEntity.ok(certificados);
    }

    @GetMapping("{id}")
    public ResponseEntity findById(@PathVariable("id") Long id) {
        Certificacoes certificados = service.buscaPorId(id);
        return ResponseEntity.ok(certificados);
    }
